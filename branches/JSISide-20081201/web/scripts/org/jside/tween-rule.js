 ...
 * 正弦衰减-增强曲线（弹动渐入渐出）
 */
TweenRuleSample.elasticBoth = toBoth(TweenRuleSample.elasticIn,TweenRuleSample.elasticOut);
/**
 * 弹球起振（弹球渐入）
 */
TweenRuleSample.bounceIn = toOut(TweenRuleSample.bounceOut);
/**
 * 弹球起振-弹球减振（弹球渐入-弹球渐出）
 */
TweenRuleSample.bounceBoth = toBoth(TweenRuleSample.bounceIn);
/**
 * 减速过界（渐出过界）
 */
TweenRuleSample.backOut = toOut(TweenRuleSample.backIn);
/**
 * 回退加速-减速过界（回退渐入-渐出过界）
 */
TweenRuleSample.backBoth = toBoth(TweenRuleSample.backIn);
