 ...
 * @author 金大为
 */
public class SimplifiedOutputStream extends OutputStream {
    /**
     * Logger for this class
     */
    private static final Log log = LogFactory.getLog(SimplifiedOutputStream.class);
    ...
    public SimplifiedOutputStream(OutputStream out) throws IOException {
        super();
...
//    }
    ...
    public void write(int b) throws java.io.IOException {
        ...
        {
            this.value |= (b & 0x3F);
            int hit = utf8.getSimplifiedWord((char)this.value,temp);
            if (hit < 1) {
                output.write(temp[0]);
                output.write((byte) b);
        ...
        default:
            throw new UTFDataFormatException("非法UTF块");
        }
